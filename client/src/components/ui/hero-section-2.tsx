            ...
            <main className="overflow-hidden">
                            ...
                            <div className="relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                                ...
                                <div className="inset-shadow-2xs ring-background dark:inset-shadow-white/20 bg-background relative mx-auto max-w-5xl overflow-hidden rounded-2xl border p-4 shadow-lg shadow-zinc-950/15 ring-1">
                                    ...
                                    <img
                                        ...
                                        src="https://images.unsplash.com/photo-1551288049-bbbda536ad89?q=80&w=2070&auto=format&fit=crop"
                ...
                <section className="bg-background pb-16 pt-16 md:pb-32">
                    <div className="group relative m-auto max-w-5xl px-6">
                        ...
                        <div className="group-hover:blur-[2px] mx-auto mt-12 grid max-w-2xl grid-cols-4 gap-x-12 gap-y-8 transition-all duration-500 group-hover:opacity-50 sm:gap-x-16 sm:gap-y-14">
                            {[
                                ...
                                <div key={i} className="flex">
                                    <img
                                        className="mx-auto h-5 w-fit dark:invert opacity-70 grayscale hover:grayscale-0 transition-all"
                                        src={src}
                                        alt="Customer Logo"
                                        height="20"
                                        width="auto"
    ...
    return (
        <header>
            <nav
                ...
                className={cn('group fixed z-30 w-full border-b transition-colors duration-150', scrolled && 'bg-background/50 backdrop-blur-3xl')}>
                <div className="mx-auto max-w-5xl px-6 transition-all duration-300">
                    <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
                        ...
                        <div className={cn(
                            "bg-background lg:flex items-center justify-end space-y-8 lg:space-y-0 lg:gap-6 lg:bg-transparent lg:p-0 transition-all duration-300 absolute lg:relative top-full left-0 w-full lg:w-auto p-6 border lg:border-none shadow-2xl lg:shadow-none hidden",
                            menuState && "block"
                        )}>
